# zapret kurulum rehberi (Discord)
...
Klasörde 19 farklı strateji dosyası var. Hangisinin çalışacağı ISP'ye göre değişir.
...
> ⚠️ Zapret servis olarak kuruluysa önce **2 (Remove Services)** ile kaldır.
